...
function LoginPage() {
  ...
  const redirectPath = location.state?.from || getPostLoginDestination() || "/";
  ...
  const handleLogin = async (provider) => {
    ...
    try {
      ...
      setPostLoginDestination(redirectPath);
      const result = await signIn(selectedRole, redirectPath);
    ...
    <div className="auth-container bg-[#121110]">
      ...
      >
        <motion.div className="auth-header" variants={itemVariants}>
          ...
          <p className="auth-subtitle">Select your role here and continue with the right access.</p>
        </motion.div>
        ...
        <motion.div className="auth-role-selector" variants={itemVariants}>
          <label className="role-label">Choose role before login:</label>
